...
**NB:** Besides **acpype**, **antechamber** and **babel**, you will need GROMACS with
ffAMBER. GROMACS 4.5.x comes with AMBER force fields now.
...
## Getting [ffAMBER](http://ffamber.cnsm.csulb.edu/) ##

If you are installing GMX 4.5.x, you don't need ffAMBER.

For GMX 4.0.x fetch the appropriate version of ffAMBER. Got it with PDFs. You
...
wget -c http://ffamber.cnsm.csulb.edu/ffamber_v4.0-doc.tar.gz
